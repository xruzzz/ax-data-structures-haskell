...
-- |
--  Чистая реализация красно-чёрного дерева
--
module RBTree (
  -- * Tree Types
...
-- Функции поиска. возращают \'Just result\' при завершении, иначе Nothing.
...
-- | Более быстрая реализация 'search'
